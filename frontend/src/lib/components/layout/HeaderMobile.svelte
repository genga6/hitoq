...
<div class="relative flex items-center justify-between">
  ...
  <div class="flex items-center">
    ...
    <button
      ...
      class="cursor-pointer border-none bg-transparent p-0 text-2xl font-bold text-orange-400"
    >
      hitoQ
    </button>
  </div>
  ...
  <div class="flex items-center space-x-2">
    <a
      href="/discover"
      class="theme-text-muted rounded-full p-2 transition-colors hover:bg-gray-100 hover:text-orange-500 dark:hover:bg-gray-800"
      aria-label="ユーザーを発見"
    >
      ...
      <div class="space-y-3 p-4">
        ...
        <div class="space-y-1">
          <a
            ...
            class="theme-text-primary theme-hover-bg flex items-center rounded-lg px-3 py-2 text-sm font-medium"
          >
          ...
          <button
            ...
            class="theme-text-primary theme-hover-bg flex w-full items-center rounded-lg px-3 py-2 text-left text-sm font-medium"
          >
            <svg class="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
