...
<div class="relative flex items-center justify-between">
  ...
  <button
    ...
    class="flex-shrink-0 cursor-pointer border-none bg-transparent p-0 text-2xl font-bold text-orange-400"
  >
    hitoQ
  </button>
  ...
  <div class="absolute right-0 flex items-center gap-2">
    <a
      ...
      aria-label="ユーザーを発見"
    >
      <svg class="theme-text-secondary h-5 w-5 md:h-6 md:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
