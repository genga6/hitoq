...
{#if clickable}
  <button
    type="button"
    class="rounded-full border border-gray-300 p-0 transition-colors hover:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 {sizeClasses[size]}"
    onclick={onclick}
    aria-label={alt}
  >
