...
<div class="relative">
  <div class="relative">
    <input
      ...
      oninput={onInput}
      onkeydown={onKeydown}
      class="theme-bg-surface theme-text-primary w-full rounded-lg border border-gray-300 py-2 pl-10 pr-4 text-sm focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 dark:border-gray-600"
