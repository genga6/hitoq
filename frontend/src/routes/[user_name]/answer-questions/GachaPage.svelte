  ...
  <div class="theme-border theme-bg-surface mt-8 rounded-2xl p-6">
    ...
    <div class="divide-y divide-gray-200 dark:divide-gray-700">
      {#each unansweredQAPairs as pair, i (`unanswered-gacha-${pair.groupId}-${pair.question.questionId}-${pair.questionIndex}`)}
        ...
        <div
          data-question-id={pair.groupId}
          class="py-6 first:pt-0 last:pb-0 {pair.isNew
            ? '-mx-2 rounded-lg border-l-4 border-orange-400 bg-orange-50 px-4 dark:bg-orange-900/20'
            : ''}"
        ...
        >
          ...
          {#if pair.isNew}
            <div
              class="mt-2 flex items-center gap-2 text-sm font-medium text-orange-600 dark:text-orange-400"
            >
