<script lang="ts">
  ...
  const { showOnlyLoggedIn }: Props = $props();
</script>

<div class="py-12 text-center">
  <div class="theme-bg-subtle mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 640"
      class="theme-text-muted h-10 w-10"
    >
      <path
  ...
  <h3 class="theme-text-primary mb-2 text-lg font-semibold">
