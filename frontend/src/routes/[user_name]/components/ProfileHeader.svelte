...
>
  ...
  {#if isOwner}
    ...
    <a
      ...
      class="theme-text-muted flex h-12 w-12 items-center justify-center overflow-hidden rounded-full ring-orange-400 transition hover:ring-2 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:outline-none absolute top-0 right-0 z-10"
      title="足跡を見る"
      aria-label="足跡を見る"
    >
      <svg
